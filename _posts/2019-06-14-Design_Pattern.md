...
이 **부정적인 시각은 어느정도 맞는 얘기입니다.** <br>

이 글의 좀 밑에 <br>
**디자인패턴이 왜 호불호가 있는지 고찰** 에서 <br>
이에 대한 내용에 대해 적겠습니다.
...
**싱글톤, 옵저버, 커맨드, 상태(FSM)** 등이 있네요. <br>

<br>

### 유니티에 적용후 장점

디자인 패턴 공부하면 생기는 장점은 다음과 같습니다. <br.
1. **전문 용어로서의 기능** <br>
 ...
 **계속 연구하며 계속 개량한 학문** 입니다. (**현재진행**) <br> <br>
이에 대해 공부하면서 **맞는 케이스를 찾아 적용하기 보다**, <br>
더 근본적인 **객체지향적 설계법을 익히는 것** 이죠.
...
일단 디자인 패턴이라는 것은 굉장히 **경험 중심의 분야** 입니다. <br>
...
### 이제 위에서 짚었던 부정적인 의견에 대해 얘기해보겠습니다.<br>

1. **적용 시키면 구조가 더 복잡해진다.** <br>
 이 경우는 제가 추측하기에 <br>
 디자인 패턴을 먼저 생각하고 설계를 해서 그렇습니다. <br>
 설계부터 어느정도 한다음, 패턴이 자연스럽게 떠올라야 <br>
 이상적으로 패턴을 맞춰서 구현할 수 있습니다. <br>


2. **적용 시키면 퍼포먼스가 떨어진다.** <br>
 퍼포먼스가 떨어지지만, 이 퍼포먼스 비용보다 <br>
 잘못된 설계에 의한 유지보수비용이 대부분의 경우 큽니다. <br> <br>
 **살짝 극단적인 예시로**, 별찍기를 예로 들면 <br>
...
이런식의 결과물을 내야 할 때, <br>
**제일 퍼포먼스가 빠른 방법은 별을 그대로 찍는 것입니다.** <br>
그러나 대부분의 프로그래머의 경우 함수로 만들어서 <br>
인자로 찍을 줄의 갯수를 받고, 3줄 뿐만 아니라 10줄도 <br>
쉽게 찍을 수 있게끔 작업하겠죠. <br>

3. **게임은 기획이 바뀌면 설계를 바꿔야 할 때가 있다.** <br>
    **= 어차피 나중에 갈아 엎게 되어있다.** <br>
 이 경우는 프로젝트마다 케바케이기도 하고, <br>
 **정말 이 경우가 맞는 프로젝트가 있을 수 있습니다.** <br>
 ~~(사람의 성격보다 더 다양한것이 프로젝트이기 때문에)~~ <br> <br>
 **하지만 어느정도, 예방할 수는 있습니다.** <br>
 <br>
 요구 사항 분석 단계에서 <br>
 개발을 시뮬레이션할 수 있는 능력이 필요합니다. <br>
 **당장 구현해야 할 사항과, 앞으로 어떻게 업데이트할지 <br>
 개발직전의 단계에서 구체화 시켜야 합니다.** <br>


### 유니티에서의 디자인패턴 사용 예시

예시는 블로그에 하나씩 포스팅하였습니다.
